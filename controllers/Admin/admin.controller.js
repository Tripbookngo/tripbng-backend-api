...
const CreateSuperAdmin = asyncHandler(async (req, res) => {
  ...
  console.log(admin);
  return res.status(200).json(new ApiResponse(200, { admin }, 'Admin Create SuccessFully'));
});
...
const LoginAdmin = asyncHandler(async (req, res) => {
  ...
  if (!email) {
    return res
      ...
      .json(
        new ApiResponse(
          400,
          { success: false, data: 'Please Enter the username' },
  ...
  if (!password) {
    return res
      ...
      .json(
        new ApiResponse(
          400,
          { success: false, data: 'Please Enter The password' },
  ...
  if (!isPasswordCorrect) {
    return res
      .status(400)
      .json(new ApiResponse(400, { success: false }, 'Please Enter Correct Password'));
  }
  ...
  return res.status(200).json(new ApiResponse(200, { sucess: true }, 'Opt is Sent on your email'));
});
...
const veryfyOTPLogin = asyncHandler(async (req, res) => {
  ...
  if (isNull([email, code])) {
    return res
      ...
      .json(
        new ApiResponse(
          400,
          { success: false, data: 'Please Enter the All fields' },
  ...
  if (!isOtpCorrect) {
    return res
      .status(400)
      .json(new ApiResponse(400, { sucess: false }, 'Please Enter Correct OTP'));
  }
    ...
    return res
      ...
      .json(
        new ApiResponse(
          500,
          { status: false },
          'Something Went wrong while generating AccessTocken'
        )
      );
  }
  const LoginUser = {
  ...
  if (!LoginUser) {
    return res
      ...
      .json(
        new ApiResponse(400, {
          success: false,
          data: 'Something went wrong while fetching LoginUser',
        })
      );
  }
...
const CreateSubAdmin = asyncHandler(async (req, res) => {
    ...
    return res
      ...
      .json(
        new ApiResponse(
          400,
          { success: false },
          'Please Choose Other Username This Username is already exist'
        )
      );
  }
  ...
  if (!email.includes('@')) {
    return res
      .status(400)
      .json(new ApiResponse(400, { success: false }, 'Please Enter Correct Email'));
  }
  ...
  if (!CreateUser) {
    return res
      .status(500)
      .json(new ApiResponse(500, { sucess: false }, 'something went Wrong While Creating Account'));
  }
  ...
  if (!user) {
    return res
      ...
      .json(
        new ApiResponse(
          400,
          { success: false, data: 'Something went wrong while load data' },
          'Something went wrong while load data'
        )
      );
  }
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, { success: true, data: user }, `Created User for ${role}`));
});

const GetAdminProflile = asyncHandler(async (req, res) => {
  return res
    .status(200)
    .json(new ApiResponse(200, { success: true, data: req.user }, 'data fetch successfully'));
});
...
const ChangePassword = asyncHandler(async (req, res) => {
  ...
  if (!isCurrentIsCorrect) {
    return res
      .status(400)
      .json(new ApiResponse(400, { success: false }, 'Please Enter Correct Current Password'));
  }

  if (CurrectPass === NewPass) {
    return res
      .status(400)
      .json(new ApiResponse(400, { success: false }, 'Your Currect And New Password is same'));
  }
  ...
  return res.status(200).json(new ApiResponse(200, { sucess: true }, 'password is change'));
});
    ...
    if (!usermail) {
      return res
        ...
        .json(
          new ApiResponse(
            400,
            { success: false, data: 'Please Enter Your mail' },
...
const ChangeForgetPassword = asyncHandler(async (req, res) => {
  ...
  if (!user) {
    ...
    if (!otpRecord) {
      return res
        .status(400)
        .json(new ApiResponse(400, { success: false }, 'Invalid or expired OTP'));
    }
...
const GetAllUser = asyncHandler(async (req, res) => {
  ...
  res.status(200).json(new ApiResponse(200, { success: true, data: AllUsers }, 'Fetched All User'));
});
...
const GiveAgentAprove = asyncHandler(async (req, res) => {
  ...
  if (user.Usertype != 'Admin') {
    return res
      ...
      .json(
        new ApiResponse(
          400,
          { success: false, data: "You Can't Aprove This request , you are not Admin" },
          "you Can't Aprove This Request Your are not Admin"
        )
      );
  }
  if (!_id) {
    return res.status(400).json(new ApiResponse(400, { success: false }, 'Id is not Geted'));
  }

  const AgentUser = await Agent.findById(_id);
  if (!AgentUser) {
    return res.status(400).json(new ApiResponse(400, { success: false }, 'Id is wrong'));
  }
  ...
  return res.status(200).json(new ApiResponse(200, { success: true }, 'Give Aprove'));
});
...
const GiveCpAprove = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, { success: true }, 'Congrts Your Request Aprove From the Admin'));
});
  ...
  if (!BlockCp) {
    return res
      ...
      .json(
        new ApiResponse(
          400,
          { success: false, data: 'Please send correct id' },
          'Please Send Correct Id'
        )
      );
  }
  return res
    .status(200)
    .json(new ApiResponse(200, { success: true, data: 'User is Deleted' }, 'User is Deleted'));
});
...
const inActiveCp = asyncHandler(async (req, res) => {
  ...
  if (!findCp) {
    return res
      .status(400)
      .json(new ApiResponse(400, { success: false, data: 'Cp is not found' }, 'Cp is not found'));
  }
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, { success: true, data: 'we block the Cp' }, 'we block the cp'));
});
  ...
  if (allBooking.length < 1) {
    return res
      ...
      .json(
        new ApiResponse(
          200,
          { success: true, data: 'not found any flight book' },
          'not found any flight book'
        )
      );
  }
  return res
    .status(200)
    .json(new ApiResponse(200, { success: true, data: allBooking }, 'fetch all data'));
});
...
const GetAllBusBooking = asyncHandler(async (req, res) => {
  ...
  if (allBooking.length < 1) {
    return res
      ...
      .json(
        new ApiResponse(
          200,
          { success: true, data: 'not any bus booking found' },
          'not any bus booking found'
        )
      );
  }
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, { success: true, data: allBooking }, 'all bus booking data fetch'));
});
...
const GetAllTravQuery = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, { success: true, data: allTravQuery }, 'data fetched'));
});
  ...
  if (allSubAdmins.length < 1) {
    return res
      ...
      .json(
        new ApiResponse(
          200,
          { success: true, data: 'not found any subadmin' },
          'not found any subadmin'
        )
      );
  }
  return res
    .status(200)
    .json(new ApiResponse(200, { success: true, data: allSubAdmins }, 'Data fetch successfully'));
});
  ...
  if (!id) {
    return res
      ...
      .json(
        new ApiResponse(
          400,
          { success: false, data: 'Please Enter All the Id' },
          'Please Enter the Id'
        )
      );
  }
  ...
  if (!Subadminuser) {
    return res
      ...
      .json(
        new ApiResponse(
          400,
          { success: false, data: 'Subadmin of this Id is not exists' },
          'Subadmin ozf this Id is not exists'
        )
      );
  }
  return res
    ...
    .json(
      new ApiResponse(
        200,
        { success: true, data: 'SubAdmin is delete successfully' },
        'Subadmin is delete successfully'
      )
    );
});
...
const GetLoginIpDetails = asyncHandler(async (req, res) => {
  ...
  if (loginIps.length == 0) {
    return res
      ...
      .json(
        new ApiResponse(
          200,
          { success: false, data: 'not any user login data found' },
          'not any user login data is found'
        )
      );
  }
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, { success: true, data: loginIps }, 'all data fetch successfully'));
});
  ...
  if (!createobject) {
    return res
      ...
      .json(
        new ApiResponse(
          500,
          { success: false, data: 'Something error while creating object' },
          'something error while creating object'
        )
      );
  }
...
const UpdateApiFlight = asyncHandler(async (req, res) => {
  ...
  if (!id || !changes) {
    return res
      ...
      .json(
        new ApiResponse(
          400,
          { success: false, data: 'please enter all things' },
  ...
  if (!findobject) {
    return res
      ...
      .json(
        new ApiResponse(
          400,
          { success: false, data: "can't find given object" },
          "can't find given object"
        )
      );
  }
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, { success: true, data: findobject }, 'object update successfully'));
});
  ...
  if (!deleteobject) {
    return res
      ...
      .json(
        new ApiResponse(
          400,
          { success: false, data: 'something problem while the deleting object' },
          'something problem while the deleting object'
        )
      );
  }
...
const GetAllApiFlight = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(201, { success: true, data: AllApiFlight }, 'fetch all ApiFlight Data'));
});
