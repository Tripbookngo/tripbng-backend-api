...
export const createFlightMarkup = AsnycHandler(async (req, res) => {
    ...
    return res.status(201).json(
        new ApiResponse(201, { success: true, data: created }, "Flight Markup created")
    );
});
...
export const getFlightMarkupById = AsnycHandler(async (req, res) => {
    ...
    if (!data) {
        return res.status(404).json(
            new ApiResponse(404, { success: false, data: null }, "Not found")
        );
    }
    return res.status(200).json(
        new ApiResponse(200, { success: true, data: formatMarkup(data) }, "Fetched")
    );
});
...
export const updateFlightMarkup = AsnycHandler(async (req, res) => {
    ...
    return res.status(200).json(
        new ApiResponse(200, { success: true, data: formatMarkup(updated) }, "Updated")
    );
});
...
export const deleteFlightMarkup = AsnycHandler(async (req, res) => {
    ...
    return res.status(200).json(
        new ApiResponse(200, { success: true, data: "Delete" }, "Delete")
    );
});
