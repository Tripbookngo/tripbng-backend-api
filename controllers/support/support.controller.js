...
const AddQuery = AsnycHandler(async(req,res)=>{
    ...
    if(!user_id || !query || !query_for)
    {
        ...
        .json(
            new ApiResponse(400,{success:false , data:"Please Enter All the Data"},"Please Enter all the Data")
        )
    }
    ...
    .json(
        new ApiResponse(200,{success:true , data:datasave},"Query save successfully")
    )
})
