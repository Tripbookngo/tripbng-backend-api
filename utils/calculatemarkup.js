...
async function dataFiller() {
    ...
    const ariline_wise_markup = await sendGetRequest('https://api.tripbng.com/markup/air/airlinewise');
    const normal_markup = await sendGetRequest('https://api.tripbng.com/markup/air/flightMarkup');
    const group_markup = await sendGetRequest('https://api.tripbng.com/markup/air/groupInquiryMarkup')
