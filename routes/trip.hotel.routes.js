...
import { searchHotel,detailSearch, cancellation, review, booking, bookingDetails, bookingCancellation, confirmHoldBooking } from '../controllers/Hotel/tripjack/tripjack.hotel.controller.js';
const router = Router();
